...
def process_input_rna_molecules(input_rna_molecules, dir_output):
    with open(input_rna_molecules, 'r') as f:
        input_rna_molecules = f.read()
...
dir_user = os.path.join(dir_base, user_id)
...
#print("str_or_nuc_to_motifs_to_seq_to_info_dict",str_or_nuc_to_motifs_to_seq_to_info_dict)
