...
def consensus(alignment):
    """consensus(StringVector alignment) -> std::string"""
    return _RNA.consensus(alignment)

def consens_mis(alignment):
    """consens_mis(StringVector alignment) -> std::string"""
...
def PS_color_aln(structure, filename, alignment, identifiers):
...
def aliPS_color_aln(structure, filename, alignment, identifiers):
...
def aliLfold(AS, structure, maxdist):
...
def file_commands_read(*args, **kwargs):
    """file_commands_read(std::string filename, unsigned int options) -> CmdVector"""
...
def enumerate_necklaces(entity_counts):
    """enumerate_necklaces(UIntVector entity_counts) -> IntIntVector"""
...
def aliLfold_cb(*args):
    """
    aliLfold_cb(AS, maxdist, cb, data) -> float
...
def pfl_fold_cb(*args, **kwargs):
    """pfl_fold_cb(std::string sequence, int window_size, int max_bp_span, PyObject * PyFunc, PyObject * data)"""
    return _RNA.pfl_fold_cb(*args, **kwargs)

def pfl_fold_up_cb(*args, **kwargs):
    """pfl_fold_up_cb(std::string sequence, int ulength, int window_size, int max_bp_span, PyObject * PyFunc, PyObject * data)"""
...
class fold_compound(object):
    ...
    def ud_add_motif(self, *args, **kwargs):
        """ud_add_motif(fold_compound self, std::string motif, double motif_en, unsigned int options)"""
    ...
    def commands_apply(self, *args, **kwargs):
        """commands_apply(fold_compound self, CmdVector commands, unsigned int options) -> int"""
    ...
    def probs_window(self, *args, **kwargs):
        """probs_window(fold_compound self, int ulength, unsigned int options, PyObject * PyFunc, PyObject * data)"""
