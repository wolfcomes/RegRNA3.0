...
def file_commands_read(*args, **kwargs) -> "std::vector< vrna_cmd_t,std::allocator< vrna_cmd_t > >":
...
def pfl_fold_cb(*args, **kwargs) -> "void":
...
def pfl_fold_up_cb(*args, **kwargs) -> "void":
...
class fold_compound(object):
    ...
    def probs_window(self, *args, **kwargs) -> "void":
