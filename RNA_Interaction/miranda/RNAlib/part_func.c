...
/*
  $Log: part_func.c,v $
  Revision 1.1  2008/06/17 17:08:42  sheridan
  Initial checkin of miRanda-3.1 as modified by Doron and purged of
  extraneous files

  Revision 1.1.1.1  2005/05/31 10:39:43  aje
  God Help Us All

  Revision 1.2  2005/01/29 10:21:12  enright
  *** empty log message ***
...
/*@unused@*/
static char rcsid[] UNUSED = "$Id: part_func.c,v 1.1 2008/06/17 17:08:42 sheridan Exp $";
