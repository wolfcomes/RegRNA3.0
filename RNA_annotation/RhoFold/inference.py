...
def main(config):
    ...
    if config.single_seq_pred:
        ...
        databases = [f'{config.database_dpath}/rnacentral.fasta']
...
if __name__ == '__main__':
    ...
    parser.add_argument("--relax_steps", help="Num of steps for structure refinement, default 1000.", default = 1000, type=int)
